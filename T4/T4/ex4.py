...
def ex4 (BA, ER):
    ...
    for lbda in lambdas_x:
        ...
        inf, _, _, _ = epidemia.reativo (BA, 'sis', num_iter_reativo, beta, mi_reativo)
        BA_reativo.append (inf[-1])

        inf, _, _, _ = epidemia.reativo (ER, 'sis', num_iter_reativo, beta, mi_reativo)
    ...
    for lbda in lambdas_x:
        ...
        inf, _, _, _ = epidemia.contato (ER, 'sis', num_iter_contato, beta, mi_contato)
        ER_contato.append (inf[-1])

        inf, _, _, _ = epidemia.contato (BA, 'sis', num_iter_contato, beta, mi_contato)
