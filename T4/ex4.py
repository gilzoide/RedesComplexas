...
def ex4 (BA, ER):
    ...
    plt.plot (lambdas_x, BA_contato, 'b-', label = 'BA')
    plt.plot (lambdas_x, ER_contato, 'r-', label = 'ER')
    plt.legend ()
    plt.xlabel ('lambda')
    ...
    plt.plot (lambdas_x, BA_reativo, 'b-', label = 'BA')
    plt.plot (lambdas_x, ER_reativo, 'r-', label = 'ER')
    plt.legend ()
    plt.xlabel ('lambda')
    plt.ylabel ('Infectados')
